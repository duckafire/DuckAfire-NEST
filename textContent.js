...
function LanguagePT(l){ // pt-BR
	...
	l[0][1].innerHTML   = "&emsp;Seja bem vindo ao meu ninho!<br>&emsp;" +
	"Aqui quem escreve é o pato charmoso da foto acima :D<br>&emsp;"     +
	"Meu nome é <strong>DuckAfire</strong>, sou um densenvolvedor de "   +
	"jogos indie que adora desafios e <em>pixel art</em>, ama <em>Lua"   +
	"</em> e <strong>adora</strong> odiar <em>CSS</em>" +
	"<br>" +
	"&emsp;Aqui nesse <em>website</em> você poderá encontrar <strong>tudo" +
	...
	l[2][1].innerHTML   = "&emsp;Depois de um longo perído de espera, finalmente "  +
	"chegou! <strong>Legendary Champion <u>v3.0.2</u>!!</strong> Uma atualização "  +
	"que veio para facilitar a criação de NOVAS atualizações, deixar as coias mais" +
	"belas e tornar a vida do <em>nosso</em> pequeno \"astronauta\" <strong>mais "  +
	"difícil!</strong>." +
	"<br><br>" +
	"&emsp;As principais mudanças dessa atualização incluem:<br>" +
	"<br>" +
